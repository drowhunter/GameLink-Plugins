...
{
    [Export(typeof(Game))]
    [ExportMetadata("Name", "Assetto Corsa Competizione")]
    [ExportMetadata("Version", "1.0")]

    public class ACCPlugin : Game
    {
        ...
        public int STEAM_ID => 805550;
        public string PROCESS_NAME => "acc";
