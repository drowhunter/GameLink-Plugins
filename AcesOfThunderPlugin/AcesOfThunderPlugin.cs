...
using AcesOfThunderPlugin.Properties;
using YawGLAPI;

namespace AcesOfThunderPlugin
{

    [Export(typeof(Game))]
    [ExportMetadata("Name", "Aces of Thunder")]
    [ExportMetadata("Version", "0.2")]
    class AcesOfThunderPlugin : Game {
