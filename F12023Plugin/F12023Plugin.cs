...
{
    [Export(typeof(Game))]
    [ExportMetadata("Name", "F1 2023")]
    [ExportMetadata("Version", "1.2")]
    public class F12023Plugin : Game
    {
        private struct F12023TelemetryData
        {
            public float speed;
        ...
        private F12023TelemetryData data;

        FieldInfo[] fields = typeof(F12023TelemetryData).GetFields();
        public int STEAM_ID => 2108330;

        public string PROCESS_NAME => "F1_23";
